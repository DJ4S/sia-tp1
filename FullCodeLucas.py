...
def mainGame(tablero_inicial, metodo='bfs'):
    if metodo == 'bfs':
        ...
        solution, expanded_nodes, frontier_nodes = bfs_solve(tablero_inicial)
        end_time = time.time()
        total_time = end_time - start_time
        return total_time, solution, expanded_nodes, frontier_nodes
    elif metodo == 'dfs':
        start_time = time.time()
        solution, expanded_nodes, frontier_nodes = dfs_solve(tablero_inicial)
        end_time = time.time()
        total_time = end_time - start_time
        return total_time, solution, expanded_nodes, frontier_nodes
    else:
...
metodo = 'bfs'  # Cambiar a 'dfs' si se prefiere la búsqueda en profundidad
total_time, solution, expanded_nodes, frontier_nodes = mainGame(tablero_inicial, metodo)
